...
#define BLE_UUID_OUR_CHARACTERISTC_UUID           0x1111 // Just a random, but recognizable value
 ...
 */
void our_characteristic_update(ble_os_t *p_our_service, int32_t *char_value);
